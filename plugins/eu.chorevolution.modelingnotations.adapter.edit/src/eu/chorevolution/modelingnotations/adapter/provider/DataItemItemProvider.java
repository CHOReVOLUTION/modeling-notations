...
/**
 * This is the item provider adapter for a {@link eu.chorevolution.modelingnotations.adapter.DataItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataItem_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataItem_name_feature", "_UI_DataItem_type"),
				 AdapterPackage.Literals.DATA_ITEM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMinOccursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataItem_minOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataItem_minOccurs_feature", "_UI_DataItem_type"),
				 AdapterPackage.Literals.DATA_ITEM__MIN_OCCURS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaxOccursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataItem_maxOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataItem_maxOccurs_feature", "_UI_DataItem_type"),
				 AdapterPackage.Literals.DATA_ITEM__MAX_OCCURS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
