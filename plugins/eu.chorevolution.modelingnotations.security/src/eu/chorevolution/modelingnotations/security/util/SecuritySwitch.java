...
public class SecuritySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecurityPackage.SECURITY_POLICY_SET: {
				SecurityPolicySet securityPolicySet = (SecurityPolicySet)theEObject;
				T result = caseSecurityPolicySet(securityPolicySet);
			...
			case SecurityPackage.COMMUNICATION: {
	 ...
	 * @generated
	 */
	public T caseSecurityPolicySet(SecurityPolicySet object) {
		return null;
	}
