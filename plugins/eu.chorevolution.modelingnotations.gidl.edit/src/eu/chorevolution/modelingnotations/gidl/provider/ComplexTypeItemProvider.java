...
/**
 * This is the item provider adapter for a {@link eu.chorevolution.modelingnotations.gidl.ComplexType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GidlPackage.Literals.DATA_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMinOccursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_minOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_minOccurs_feature", "_UI_DataType_type"),
				 GidlPackage.Literals.DATA_TYPE__MIN_OCCURS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaxOccursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_maxOccurs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_maxOccurs_feature", "_UI_DataType_type"),
				 GidlPackage.Literals.DATA_TYPE__MAX_OCCURS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GidlPackage.Literals.COMPLEX_TYPE__HAS_DATA_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GidlPackage.Literals.COMPLEX_TYPE__HAS_DATA_TYPE,
				 GidlFactory.eINSTANCE.createSimpleType()));

		newChildDescriptors.add
			(createChildParameter
				(GidlPackage.Literals.COMPLEX_TYPE__HAS_DATA_TYPE,
				 GidlFactory.eINSTANCE.createComplexType()));
	}
