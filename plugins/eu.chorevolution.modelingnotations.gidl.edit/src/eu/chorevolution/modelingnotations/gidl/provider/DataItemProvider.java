...
/**
 * This is the item provider adapter for a {@link eu.chorevolution.modelingnotations.gidl.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GidlPackage.Literals.DATA__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_context_feature", "_UI_Data_type"),
				 GidlPackage.Literals.DATA__CONTEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMediaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_media_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_media_feature", "_UI_Data_type"),
				 GidlPackage.Literals.DATA__MEDIA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GidlPackage.Literals.DATA__HAS_DATA_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GidlPackage.Literals.DATA__HAS_DATA_TYPE,
