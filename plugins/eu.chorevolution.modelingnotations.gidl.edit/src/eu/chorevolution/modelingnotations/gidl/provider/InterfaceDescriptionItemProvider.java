...
/**
 * This is the item provider adapter for a {@link eu.chorevolution.modelingnotations.gidl.InterfaceDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceDescriptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InterfaceDescription_role_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InterfaceDescription_role_feature", "_UI_InterfaceDescription_type"),
				 GidlPackage.Literals.INTERFACE_DESCRIPTION__ROLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GidlPackage.Literals.INTERFACE_DESCRIPTION__HAS_OPERATIONS);
		}
	...
	public String getText(Object object) {
		RoleTypes labelValue = ((InterfaceDescription)object).getRole();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GidlPackage.Literals.INTERFACE_DESCRIPTION__HAS_OPERATIONS,
				 GidlFactory.eINSTANCE.createOperation()));
	}
