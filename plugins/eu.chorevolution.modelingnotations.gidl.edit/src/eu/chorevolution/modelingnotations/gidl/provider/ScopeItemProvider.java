...
/**
 * This is the item provider adapter for a {@link eu.chorevolution.modelingnotations.gidl.Scope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GidlPackage.Literals.SCOPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addVerbPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scope_verb_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scope_verb_feature", "_UI_Scope_type"),
				 GidlPackage.Literals.SCOPE__VERB,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUriPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scope_uri_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scope_uri_feature", "_UI_Scope_type"),
				 GidlPackage.Literals.SCOPE__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
