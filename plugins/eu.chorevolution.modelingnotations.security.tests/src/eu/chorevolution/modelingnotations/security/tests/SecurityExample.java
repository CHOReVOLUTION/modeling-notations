...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>security</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.security"));
				SecurityPolicySet root = SecurityFactory.eINSTANCE.createSecurityPolicySet();
